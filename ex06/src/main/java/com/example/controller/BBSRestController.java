...
public class BBSRestController {
	...
	@GetMapping("/list.json")	//테스트 : /bbs/list.json?key=uname&word=&page=1&size=3
	...
	@GetMapping("/{bid}")
	public BBSVO read(@PathVariable("bid") int bid, @RequestParam("isViewCnt") boolean isViewCnt) {
